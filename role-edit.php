    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-4 bg-dark text-center text-info p-5 rounded">
                <h3 class="mb-3"><strong>( <?= $role->name; ?> )  Role Edit </strong></h3>
                ...
                <form action="role-update.php" method="POST">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="name" value="<?= $role->name; ?>" class="form-control" placeholder="Role Name ..." aria-label="Name" aria-describedby="basic-addon1" required>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-dark text-info" id="basic-addon1"><i class="fa fa-sort-numeric-desc" aria-hidden="true"></i></span>
                        <input type="text" name="value" value="<?= $role->value; ?>" class="form-control" placeholder="Role Value ..." aria-label="Value" aria-describedby="basic-addon1" required>
                    </div>
                    <button type="submit" class="btn btn-primary w-100 float-end mb-4"><i class="fa fa-save"></i> Update</button>
                </form>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="role-del.php?id=<?= $role->id ?>" class="btn btn-danger btn-sm" title="Delete"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
